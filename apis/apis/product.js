...
export default {
    ...
    addProduct:(args)=>{
     ...
     getProductById:(args)=>{
        ...
        return axios.post(process.env.NEXT_PUBLIC_MERI_WEBSITE+'/api/products/getProductById', {  
             ...args,
             token:localStorage.getItem('token')
         });
    ...
    deleteProduct:(args)=>{
       ...
       return axios.post(process.env.NEXT_PUBLIC_MERI_WEBSITE+'/api/products/deleteProduct', {  
            ...args,
            token:localStorage.getItem('token')
        });
